...
export const StaggeredMenu = ({
  ...
  const buildOpenTimeline = useCallback(() => {
    ...
    const footerEl = panel.querySelector('.sm-footer-item');
    ...
    if (footerEl) gsap.set(footerEl, { opacity: 0, y: 12 });
        ...
        <div className="sm-panel-inner">
          ...
          {footerItem && (
            <div className="sm-footer">
              ...
              <a
                href="#"
                className="sm-footer-item"
                onClick={handleFooterClick}
                aria-label={footerItem.label}
              >
                <span className="sm-panel-itemLabel">{footerItem.label}</span>
              </a>
            </div>
          )}
        </div>
